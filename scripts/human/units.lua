...
DefineUnitType("unit-attack-peasant", { Name = _("Rebel Peasant"),
  Image = {"file", "human/units/peasant.png", "size", {72, 72}},
  DrawLevel = 19,
  Animations = "animations-peasant", Icon = "icon-peasant",
  Costs = {"time", 45, "gold", 400},
...
DefineUnitType("unit-medivh", { Name = _("Medivh"),
  Image = {"file", "human/units/mage.png", "size", {72, 72}},
  Animations = "animations-mage", Icon = "icon-medivh",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  Level = 10,
  HitPoints = 200,
  ...
  TileSize = {1, 1}, BoxSize = {33, 33},
  SightRange = 9, ComputerReactionRange = 11, PersonReactionRange = 9,
  Armor = 2, BasicDamage = 5, PiercingDamage = 20, Missile = "missile-dragon-breath",
  MaxAttackRange = 8,
  Priority = 70,
  Points = 100,
  DetectCloak = true,
  ...
  Sounds = {
    ...
    "ready", "mage-ready",
    "help", "basic human voices help 1",
    "dead", "human hero dead"} } )
	
  DefineUnitType("unit-kael", { Name = _("Kael'thas Sunstrider"),
  Image = {"file", "human/units/mage.png", "size", {72, 72}},
  Animations = "animations-mage", Icon = "icon-kael",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  Level = 10,
  HitPoints = 180,
  ...
  TileSize = {1, 1}, BoxSize = {33, 33},
  SightRange = 9, ComputerReactionRange = 11, PersonReactionRange = 9,
  BasicDamage = 5, PiercingDamage = 18, Missile = "missile-lightning",
  MaxAttackRange = 4,
  Priority = 70,
  Points = 100,
  Demand = 1,
  ...
  DefineUnitType("unit-antonidas", { Name = _("Antonidas"),
  Image = {"file", "human/units/mage.png", "size", {72, 72}},
  Animations = "animations-mage", Icon = "icon-antonidas",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  Level = 10,
  HitPoints = 175,
  ...
  TileSize = {1, 1}, BoxSize = {33, 33},
  SightRange = 9, ComputerReactionRange = 11, PersonReactionRange = 9,
  BasicDamage = 6, PiercingDamage = 17, Missile = "missile-lightning",
  MaxAttackRange = 3,
  Priority = 70,
  Points = 100,
  Demand = 1,
...
DefineUnitType("unit-aiden", { Name = _("Aiden Perenolde"),
  Image = {"file", "human/units/knight.png", "size", {72, 72}},
  Animations = "animations-paladin", Icon = "icon-aiden",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Level = 10,
  Speed = 13,
  HitPoints = 110,
  ...
  TileSize = {1, 1}, BoxSize = {42, 42},
  SightRange = 5, ComputerReactionRange = 7, PersonReactionRange = 5,
  Armor = 5, BasicDamage = 10, PiercingDamage = 8, Missile = "missile-none",
  MaxAttackRange = 1,
  Priority = 65,
  Points = 110,
  Demand = 1,
...
DefineUnitType("unit-arthas", { Name = _("Arthas Menethil"),
  Image = {"file", "human/units/knight.png", "size", {72, 72}},
  Animations = "animations-paladin", Icon = "icon-arthas",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Level = 10,
  Speed = 13,
  HitPoints = 120,
  ...
  TileSize = {1, 1}, BoxSize = {42, 42},
  SightRange = 5, ComputerReactionRange = 7, PersonReactionRange = 5,
  Armor = 6, BasicDamage = 10, PiercingDamage = 6, Missile = "missile-none",
  MaxAttackRange = 1,
  Priority = 65,
  Points = 110,
  Demand = 1,
...
DefineUnitType("unit-dwarves", { Name = _("Dwarves"),
  ...
  AutoCastActive = {"spell-suicide-bomber"},
  CanAttack = true,
  CanTargetLand = true,
  LandUnit = true,
  volatile = true,
...
DefineUnitType("unit-nuke", { Name = _("Tactical Nuke Squad"),
  Image = {"file", "human/units/dwarven_demolition_squad.png", "size", {56, 56}},
  Animations = "animations-dwarves", Icon = "icon-ballista2",
  Costs = {"time", 320, "gold", 1200, "wood", 500, "oil", 200},
  Speed = 11,
  HitPoints = 20,
  DrawLevel = 40,
  TileSize = {1, 1}, BoxSize = {32, 32},
...
DefineUnitType("unit-ranger", { Name = _("Ranger"),
  ...
  DefineUnitType("unit-sylvanas", { Name = _("Sylvanas Windrunner"),
  Image = {"file", "human/units/elven_archer.png", "size", {72, 72}},
  Animations = "animations-ranger", Icon = "icon-sylvanas",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Level = 10,
  Speed = 10,
  HitPoints = 110,
  DrawLevel = 40,
  TileSize = {1, 1}, BoxSize = {33, 33},
  SightRange = 9, ComputerReactionRange = 9, PersonReactionRange = 7,
  BasicDamage = 10, PiercingDamage = 19, Missile = "missile-arrow",
  MaxAttackRange = 6,
  Priority = 57,
  Points = 70,
  Demand = 1,
  ...
  DefineUnitType("unit-vereesa", { Name = _("Vereesa Windrunner"),
  Image = {"file", "human/units/elven_archer.png", "size", {72, 72}},
  Animations = "animations-ranger", Icon = "icon-vereesa",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Level = 10,
  Speed = 10,
  HitPoints = 100,
  ...
  TileSize = {1, 1}, BoxSize = {33, 33},
  SightRange = 9, ComputerReactionRange = 9, PersonReactionRange = 7,
  BasicDamage = 7, PiercingDamage = 10, Missile = "missile-arrow",
  MaxAttackRange = 6,
  Priority = 57,
  Points = 70,
  Demand = 1,
...
DefineUnitType("unit-female-hero", { Name = _("Alleria Windrunner"),
  Image = {"file", "human/units/elven_archer.png", "size", {72, 72}},
...
DefineUnitType("unit-flying-angel", { Name = _("Kurdran and Sky'ree"),
  Image = {"file", "human/units/gryphon_rider.png", "size", {80, 80}},
  DrawLevel = 45,
...
DefineUnitType("unit-white-mage", { Name = _("Khadgar"),
  ...
  organic = true,
  SelectableByRectangle = true,
  AutoCastActive = {"spell-slow-khadgar"},
  Sounds = {
...
DefineUnitType("unit-human-destroyer", { Name = _("Elven Destroyer"),
...
DefineUnitType("unit-flagship", { Name = _("Flagship of Admiral"),
  Image = {"file", "human/units/battleship.png", "size", {88, 88}},
  Animations = "animations-battleship", Icon = "icon-battleship",
  Costs = {"time", 140, "gold", 1000, "wood", 500, "oil", 1000},
  Speed = 5,
  ...
  TileSize = {2, 2}, BoxSize = {70, 70},
  SightRange = 9, ComputerReactionRange = 11, PersonReactionRange = 9,
  Armor = 30, BasicDamage = 350, PiercingDamage = 70, Missile = "missile-big-cannon",
  MaxAttackRange = 10,
  Priority = 63, AnnoyComputerFactor = 25,
  Points = 300,
  Demand = 1,
  ...
  SelectableByRectangle = true,
  Sounds = {
    "selected", "human-oil-tanker-acknowledge",
    "acknowledge", "human-oil-tanker-acknowledge",
    "ready", "battleship-ready",
    "help", "basic human voices help 1",
    "dead", "admiral dead"} } )
...
DefineUnitType("unit-fighter", { Name = _("Gnomish Fighter"),
  Image = {"file", "human/units/gnomish_flying_machine.png", "size", {80, 80}},
  Animations = "animations-fighter", Icon = "icon-gnomish-flying-machine",
  Costs = {"time", 65, "gold", 500, "wood", 100},
  RepairHp = 2,
  RepairCosts = {"gold", 2, "wood", 2},
  Speed = 17,
  ...
  TileSize = {2, 2}, BoxSize = {63, 63},
  SightRange = 9, ComputerReactionRange = 8, PersonReactionRange = 6,
  Armor = 3, BasicDamage = 0, PiercingDamage = 20, Missile = "missile-submarine-missile",
  MaxAttackRange = 3,
  Priority = 40,
  Points = 40,
  Demand = 1,
...
DefineUnitType("unit-gryphon-rider-test", { Name = _("Test Rider"),
  Image = {"file", "human/units/gryphon_rider.png", "size", {80, 80}},
  DrawLevel = 45,
  Animations = "animations-fighter", Icon = "icon-gryphon-rider",
  Costs = {"time", 250, "gold", 2500},
  Mana = {Enable = true},
  Speed = 14,
  HitPoints = 100,
  ...
  TileSize = {2, 2}, BoxSize = {63, 63},
  SightRange = 6, ComputerReactionRange = 8, PersonReactionRange = 6,
  Armor = 5, BasicDamage = 0, PiercingDamage = 16, Missile = "missile-submarine-missile",
  MaxAttackRange = 4,
  Priority = 65,
  Points = 150,
  Demand = 1,
...
DefineUnitType("unit-arthor-literios", { Name = _("Danath Trollbane"),
  Image = {"file", "human/units/footman.png", "size", {72, 72}},
...
DefineUnitType("unit-wise-man", { Name = _("Anduin Lothar"),
  Image = {"file", "human/units/knight.png", "size", {72, 72}},
  ...
  Armor = 12, BasicDamage = 24, PiercingDamage = 12, Missile = "missile-none",
  MaxAttackRange = 1,
  Priority = 65,
  Points = 120,
  Demand = 1,
...
DefineUnitType("unit-man-of-light", { Name = _("Uther Lightbringer"),
  ...
  TileSize = {1, 1}, BoxSize = {42, 42},
  SightRange = 6, ComputerReactionRange = 7, PersonReactionRange = 6,
  Armor = 8, BasicDamage = 12, PiercingDamage = 6, Missile = "missile-none",
  MaxAttackRange = 1,
  Priority = 65,
  Points = 120,
  Demand = 1,
...
DefineUnitType("unit-inventor", { Name = _("Gnomish Inventor"),
  Image = {"size", {96, 96}},
...
DefineUnitType("unit-elven-lumber-mill", { Name = _("Elven Lumber Mill"),
  Image = {"size", {96, 96}},
